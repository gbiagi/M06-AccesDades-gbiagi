...
public class Agenda {
    ...
    public static void main(String args[]){
        ...
        a.mostrarAgenda();
        // Añadir personas de la Array
        for (int j = 0; j < contactes.length; j++) {
                a.insertarAgenda(contactes[j], " - ");
        }
        a.mostrarAgenda();
    }
    ...
    public void insertarAgenda(String Nom, String Telefon){
        persones.put(Nom, Telefon);
    }
}
